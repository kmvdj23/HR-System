...
function setChartCandidateStatus(canvasId, labels, values, colors, darkColors) {
...
function setChartHRProcess(canvasId, hrList, applicantCountList){
    // Bar Chart Example
        ...
        options: {
            ...
            scales: {
                ...
                yAxes: [{
                    ticks: {
                        min: 0,
                        max: Math.ceil(Math.max.apply(Math, applicantCountList) / 10) * 10,
                        maxTicksLimit: 10,
                        padding: 10,
...
function setChartMonthlyApplicants(canvasId, values) {
    // Area Chart Example
    var ctx = document.getElementById(canvasId);
